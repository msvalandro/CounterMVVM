...
**Counter MVVM** is an Android mobile application built using Kotlin and Jetpack Compose. This is a simple counter app using MVVM (Mode View View Model) architecture to learn its concepts.
...
1. Clone the repository:
    ```sh
    git clone https://github.com/msvalandro/CounterMVVM.git
    cd CounterMVVM
    ```
